...
if (isset($_POST['username'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $sql = "insert into login (username,password,email) values ('" . $uname . "','" . $password . "','" . $email . "')";
        if ($mysqli->query($sql) === TRUE) {
            echo '<script language="javascript">';
            echo 'alert("Registered! You can login Now!")';
            echo '</script>';
        } else {
            echo "<script>alert('Some ERR!')</script>";
        }
    }
}
?>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form method="POST" action="/register.php">
                ...
                <input style="cursor: pointer; width: 30em" type="submit" class="fadeIn fourth" value="Register" />
            </form>
